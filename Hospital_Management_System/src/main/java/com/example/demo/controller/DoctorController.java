...
public class DoctorController {
	...
	public List<DoctorModel> getAllEmployee(){
	...
	public String deleteDoctorById(@PathVariable("DR_ID") Integer id) {
		...
		if(b) {
			...
			throw new NotFoundException("Employee Not found using id " + id);
	...
	public String updateDoctor(@RequestBody DoctorModel doctor) {
		...
		if(b) {
			return "Employee Record update with id"+doctor;
		}
		else {
			throw new NotFoundException("Employee Not found using id " + doctor.getId());
